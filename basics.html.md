...
def gen(
    func, seq, cond:function=<function ret_true at 0x7f0fc665f9c0>
):
...
def groupby(
    x, key, val:function=<function noop at 0x7f0fd9b20b80>
):
...
def filter_ex(
    iterable, f:function=<function noop at 0x7f0fd9b20b80>, negate:bool=False, gen:bool=False, kwargs:VAR_KEYWORD
):
...
def maps(
    args:VAR_POSITIONAL, retain:function=<function noop at 0x7f0fd9b20b80>
):
