...
def walk(
    ...
    keep_file:callable=<function ret_true at 0x7fcd813254e0>, # function that returns True for wanted files
    keep_folder:callable=<function ret_true at 0x7fcd813254e0>, # function that returns True for folders to enter
    skip_folder:callable=<function ret_false at 0x7fcd81325580>, # function that returns True for folders to skip
    func:callable=<function join at 0x7fcd8171ccc0>, # function to apply to each matched file
...
def ReindexCollection(
    coll, idxs:NoneType=None, cache:NoneType=None, tfm:function=<function noop at 0x7fcd814c4b80>
):
